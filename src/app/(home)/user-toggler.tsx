...
export default function HomeUserToggler({ user }: UserTogglerType) {
  ...
  return (
    <div className="w-fit">
      <DropdownMenu>
        <DropdownMenuTrigger className="relative inline-flex cursor-pointer items-center gap-2 rounded-md border border-zinc-200 bg-white px-2 py-1.5 text-sm/6 hover:bg-zinc-50">
          <Avatar className="border-primaryColor h-6 w-6 rounded-full border-2">
