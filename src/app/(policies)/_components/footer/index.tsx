...
const navigation = {
  main: [
    { name: 'Press', href: '#' },
    { name: 'Jobs', href: '#' },
    { name: 'Xfinity Pros', href: 'https://www.xfinitypros.com' },
    { name: 'Contact', href: '#' },
  ],
  social: [
    {
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/xfinitypros',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg
          fill="currentColor"
          height="50px"
...
export default function PoliciesFooter() {
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; 2023 - {new Date().getFullYear()} IBZIM, Inc. All rights
          reserved.
        </p>
      </div>
    </footer>
