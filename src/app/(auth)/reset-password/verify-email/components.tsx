...
import PasswordResetEmailVerificationForm from './forms';
import { Icons } from '@/components/icons';
import { PasswordResetSession } from '@/lib/server/constants';
import Link from 'next/link';
import { ExternalLink } from 'lucide-react';

export default function VerifyEmailPasswordResetComponents({
  session,
}: {
