...
import ResetPasswordWrapper from './reset-password';
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <div className="mx-auto mt-12 mb-8 w-fit">
            <Link href="/">
              <Icons.logo className="h-12 w-fit" />
            </Link>
          </div>
          <h2 className="text-center text-2xl/9 font-light tracking-tight text-gray-900 md:text-3xl">
            Reset password
          </h2>
          {callbackUrl && (
