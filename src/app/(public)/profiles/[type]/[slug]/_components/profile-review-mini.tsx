...
export function ProfileReviewMini({
  ...
  review: any;
  setReviewFeedback: Dispatch<SetStateAction<Record<string, any>>>;
  reviewFeedback: Record<string, any>;
  user: User | null;
}) {
  ...
  const handleFeedback = (reviewId: string, feedbackType: any) => {
  ...
  const isReviewEditable = (review: any) => {
