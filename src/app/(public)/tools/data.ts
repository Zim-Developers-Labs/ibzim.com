...
export const ibZimAnswers: Answer[] = [
  {
    ...
    userId: 'ibzim',
    isVerified: true,
    createdAt: new Date('2025-06-24T10:30:00Z'),
    questionId: 'fuel-stations',
    updatedAt: new Date('2025-06-24T10:30:00Z'),
  },
  {
    id: 'ibzim-answer-2',
    content:
  ...
  },
  {
    ...
    userId: 'ibzim',
    isVerified: true,
    createdAt: new Date('2025-06-24T09:45:00Z'),
    questionId: 'reduce-fuel-cost',
    updatedAt: new Date('2025-06-24T09:45:00Z'),
  },
];
