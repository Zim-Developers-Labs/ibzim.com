        ...
        <div className="mb-6">
          ...
          <Alert className="border-primaryColor mb-6 border bg-yellow-200">
            ...
            <AlertDescription className="text-primary">
              Figures provided are estimates and averages based on available
              data. For better experience rotate your phone or use IBZIM on
              wider screens like laptops or tablets.
            </AlertDescription>
          </Alert>
