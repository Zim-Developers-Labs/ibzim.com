...
export default function SchoolPickerPageWrapper() {
  ...
  const locations = useMemo(
    () => [
      'all',
      ...Array.from(new Set(allSchools.map((school) => school.location))),
    ],
    [],
  );
  ...
  const types = useMemo(
    () => [
      'all',
      ...Array.from(new Set(allSchools.map((school) => school.type))),
    ],
    [],
  );
        ...
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Find a school based on your preferences
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-2xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Search and filter schools by location and type.
            </CardDescription>
          </CardHeader>
          <CardContent>
