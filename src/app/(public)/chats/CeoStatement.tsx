...
export default function CeoSatement() {
  return (
        ...
        <div className="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
          ...
          >
            <div
              ...
              className="to-primaryColor aspect-1097/845 w-274.25 bg-linear-to-r from-[#ff4694] opacity-[0.45]"
            />
          </div>
          <div
            aria-hidden="true"
          ...
          >
            <div
              ...
              className="to-primaryColor aspect-1097/845 w-274.25 bg-linear-to-r from-[#ff4694] opacity-25"
            />
          </div>
          <div className="relative mx-auto max-w-2xl lg:mx-0">
            <WorkCationIcon className="h-12 w-auto" />
            <figure>
              <blockquote className="mt-6 text-lg font-semibold text-white sm:text-xl/8">
                <p>
                  &quot;Its these subtle conversations which sometimes change
                  our perspective for better or worse. Being in an environment
                  with like minded individuals can open up new doors for you.
                  You never know until you try.&quot;
                </p>
              </blockquote>
              <figcaption className="mt-6 text-base text-white">
                <div className="font-semibold">Tino Mazorodze</div>
                <div className="mt-1">President of IBZim</div>
              </figcaption>
            </figure>
          </div>
        </div>
