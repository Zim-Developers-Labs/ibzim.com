...
import ArticleTruthScore from './truth-score';
import HeroImage from './hero-image';
import ActionsBar from './actions-bar';
import ProductListing from './product-listing';
import { ArticleTblContents } from './tbl-contents';
...
export default function ArticleComponents({ article }: ArticleLayoutProps) {
  ...
  return (
    <>
      ...
      <div className="relative">
        <ActionsBar
          user={user}
          ArticleTruthScore={ArticleTruthScore}
