...
export interface DeleteVerificationTemplateProps {
  code: string;
}

export const DeleteVerificationTemplate = ({
  code,
}: DeleteVerificationTemplateProps) => {
  return (
    <Html>
      <Head />
      <Preview>
        Verify your email address to complete your {APP_TITLE} account deletion
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Text style={mainText}>
                you are about to permanently delete your account. We want to
                make sure it&#39;s really you. Please enter the following
                verification code when prompted. If you don&apos;t want to
                delete your account, you can ignore this message.
              </Text>
