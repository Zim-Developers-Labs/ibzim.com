    ...
    >
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto bg-black/70">
        <div className="flex min-h-full items-center justify-center">
          <DialogPanel className="relative w-full max-w-[300px] rounded-xl bg-white backdrop-blur-2xl duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0">
            <div className="divide-y divide-gray-200 text-sm">
              ...
              <div className="flex gap-2 px-4 py-4 md:gap-4 md:px-6">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">
                    &gt; 10,000 points rank. Prominent IB figures
                  </div>
                </div>
              </div>
